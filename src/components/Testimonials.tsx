...
import { Linkedin, Quote, Camera } from "lucide-react";
import { useState } from "react";

// 🔹 IMPORT IMAGES
import img1 from "@/assets/link1.png";
import img2 from "@/assets/link4.png";
import img3 from "@/assets/link3.png";
import img4 from "@/assets/link2.png";
import img5 from "@/assets/link7.png";
import img6 from "@/assets/link8.png";
import img7 from "@/assets/link5.png";
import img8 from "@/assets/link6.png";
...
const testimonials = [
  ...
  },
  {
    ...
    text:
      "Got a call for an internship offer & launched my tech portfolio! I built a dedicated space showcasing my IoT, embedded systems & hardware projects that reflect my hands-on design mindset.",
    link:
            ...
            {testimonials.map((t, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col gap-3">
                  ...
                  <p className="text-sm text-[#e81cff]/80">{t.role}</p>
                ...
                {/* 📷 CAMERA ICON */}
                <button
                  onClick={() => setActiveImage(t.image)}
                  className="absolute bottom-4 right-4 z-20
                  p-2 rounded-full bg-black/60 border border-white/20
                  text-[#e81cff] hover:scale-110 transition"
                >
                  <Camera size={18} />
                </button>
              </motion.div>
